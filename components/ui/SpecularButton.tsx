...
import { useRef, useEffect, type ButtonHTMLAttributes, type CSSProperties, type ReactNode, type MouseEventHandler } from 'react';
import { Renderer, Program, Mesh, Triangle, Color } from 'ogl';

type ButtonSize = 'sm' | 'md' | 'lg';

export interface SpecularButtonProps
  extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'children' | 'onClick' | 'type' | 'style'> {
  children?: ReactNode;
  size?: ButtonSize;
  radius?: number;
  tint?: string;
