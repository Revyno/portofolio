...
/** Client UI for /projects — filter chips + grid. Data comes from the server
 *  (RSC) so the page is never blank while a client fetch is in flight. */
export function ProjectsView({ projects: all }: { projects: Project[] }) {
